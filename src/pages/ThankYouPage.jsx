...
function LogoGlow() {
  return (
    ...
    >
      ...
      >
        <svg width="44" height="44" viewBox="0 0 32 32" fill="none" style={{ display: "block" }}>
          <defs>
            <radialGradient id="ty-bg" cx="40%" cy="25%" r="75%">
              <stop offset="0%" stopColor="#1e1b4b" />
              <stop offset="100%" stopColor="#07081a" />
            </radialGradient>
            <radialGradient id="ty-peak" cx="35%" cy="35%" r="65%">
              <stop offset="0%" stopColor="#e0e7ff" />
              <stop offset="100%" stopColor="#818CF8" />
            </radialGradient>
            <filter id="ty-glow" x="-100%" y="-100%" width="300%" height="300%">
              <feGaussianBlur in="SourceGraphic" stdDeviation="2.2" result="blur" />
              <feMerge><feMergeNode in="blur" /><feMergeNode in="SourceGraphic" /></feMerge>
            </filter>
          </defs>
          <rect width="32" height="32" rx="7.5" fill="url(#ty-bg)" />
          ...
          <circle cx="24.5" cy="9" r="5.5" fill="rgba(129,140,248,0.18)" filter="url(#ty-glow)" />
          <circle cx="24.5" cy="9" r="3" fill="url(#ty-peak)" filter="url(#ty-glow)" />
